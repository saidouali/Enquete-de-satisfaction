...
<form action="Modification.php" name="Enquete" method="post">
    <p class="obligation"><i>Complétez le formulaire. Tout les champs sont obligatoires </i><em>*</em> sont <em>obligatoires</em></p>
</br></br>
<div class="classy">
    <fieldset>
    ...
    <br>
        ...
        <input id="nom" placeholder="Son" autofocus="" required="" onblur="traiterNom()" style="font-size: 25px;" >
        <br><br>

        <label for="prenom">Prenom <em>*</em></label>
        <input id="Prenom" placeholder="Goku" autofocus="" required="" onblur="traiterPrenom()" style="font-size: 25px;"><br>
        <span id='missPrenom'></span><br>
        
        <label for="telephone">Portable <em>*</em></label>
        <input id="telephone"  placeholder="0xxxxxxxxx" pattern="06[0-9]{8}" maxlength="10" onblur="traiterNumero()" style="font-size: 25px;"><br><br>

        <label for="email">Email <em>*</em></label>
        <input id="email" type="email" placeholder="prenom.nom@xxx.com" required="" onblur="traiterEmail()" pattern="[a-zA-Z]*.[a-zA-Z]*@polytechnique.edu"  style="font-size: 25px;"><br>
        ...
        <input id="Profession" placeholder="Chomeur" autofocus="" required="" onblur="traiterProfission()" style="font-size: 25px;"><br>
    </br></br>
